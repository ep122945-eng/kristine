...
export const PRODUCTS: Product[] = [
  {
    ...
    price: 350.00,
    image: '/images/products/alpha-arbutin-serum.jpg',
    category: 'skincare',
    stock: 25,
    rating: 4.9,
    reviews: 156
  },
  {
    ...
    price: 420.00,
    image: '/images/products/brightening-moisturizer.jpg',
    category: 'skincare',
    stock: 40,
    rating: 4.8,
    reviews: 210
  ...
  },
  {
    ...
    price: 390.00,
    image: '/images/products/niacinamide-serum-lotion.jpg',
    category: 'skincare',
    stock: 18,
    rating: 4.8,
    reviews: 143
  },
  {
    ...
    price: 199.00,
    image: '/images/products/mascara-pinkflash.jpg',
    category: 'makeup',
    stock: 50,
    rating: 4.9,
    reviews: 320
  },
  {
    ...
    price: 380.00,
    image: '/images/products/sunscreen-originote.jpg',
    category: 'skincare',
    stock: 60,
    rating: 4.9,
    reviews: 245
  },
  {
    ...
    price: 250.00,
    image: '/images/products/perfume-owen-james.jpg',
    category: 'makeup',
    stock: 35,
    rating: 4.8,
    reviews: 78
  },
  {
    ...
    price: 220.00,
    image: '/images/products/perfume-quinnbella.jpg',
    category: 'makeup',
    stock: 28,
    rating: 4.7,
    reviews: 54
  },
  {
    ...
    price: 450.00,
    image: '/images/products/spa-milk-lotion.jpg',
    category: 'skincare',
    stock: 20,
    rating: 4.9,
    reviews: 112
  },
  {
    ...
    price: 350.00,
    image: '/images/products/lip-liner-set.jpg',
    category: 'makeup',
    stock: 12,
    rating: 4.6,
    reviews: 42
  },
  {
    ...
    price: 299.00,
    image: '/images/products/face-mist.jpg',
    category: 'makeup',
    stock: 45,
    rating: 4.8,
    reviews: 96
...
export const GALLERY: GalleryImage[] = [
  {
    id: '1',
    src: '/images/products/alpha-arbutin-serum.jpg',
    alt: 'Alpha Arbutin Serum',
    category: 'Skincare'
  },
  {
    id: '2',
    src: '/images/products/cushion-foundation.jpg',
    alt: 'Magic Cushion',
    category: 'Makeup'
  },
  {
    id: '3',
    src: '/images/products/brightening-moisturizer.jpg',
    alt: 'Brightening Moisturizer',
    category: 'Skincare'
  },
  {
    id: '4',
    src: '/images/products/eyeshadow-palette.jpg',
    alt: 'Earth Tones Palette',
    category: 'Makeup'
  },
  {
    id: '5',
    src: '/images/products/sunscreen-originote.jpg',
